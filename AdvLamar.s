...
MAIN:
IMPRIME_FASE1:	
	ImpressaoF(Transicao1, 0xFF100000, 0, TROCA_FRAMEI)	#tela de transiÃƒÆ’Ã‚Â§ao com informaÃƒÆ’Ã‚Â§oes da fase e senha
	TROCA_FRAMEI:
		Frame(1)
		Delay(5000)
...
la t0, ABRIR_BAU	# endereÃƒÂ§o do POWER_LAMAR

li t1, 2		# <----------------------------------------------------------------------------DETERMINAR QUANTIDADE DE POWERS DA FASE
	
sw t1, 0(t0)		# salva o power do lamar minimo para abrir bau

la t0,POWER_LAMAR	# endereÃƒÂ§o do POWER_LAMAR
li t1, 0		#lamar comeÃ§a com 0 de power sempre
...
IMPRIME_FASE2:	
	jal s5, MUSICA_RESET		
	jal s5, MUSICA3
	ImpressaoF(Transicao2, 0xFF100000, 0, TROCA_FRAMEII)	#tela de transiÃƒÆ’Ã‚Â§ao com informaÃƒÆ’Ã‚Â§oes da fase e senha
	TROCA_FRAMEII:
		Frame(1)
		Delay(5000)
	...
	CAIXADIR2:
		...
		CAIXADIR3:
			...
			CAIXADIR4:
				...
				li t2, 0x100000
				add s6, a6, t2
				ImpressaopequenaC(caixa, a6, s6, 0, 304, APAGADIR)
	...
	CAIXAESQ2:
		...
		CAIXAESQ3:
			...
			CAIXAESQ4:
				...
				li t2, 0x100000
				add s6, a6, t2
				ImpressaopequenaC(caixa, a6, s6, 0, 304, APAGAESQ)
	...
	CAIXACIMA2:
		...
		CAIXACIMA3:
			...
			CAIXACIMA4:
				...
				li t2, 0x100000
				add s6, a6, t2
				ImpressaopequenaC(caixa, a6, s6, 0, 304, APAGACIMA)
	...
	CAIXABAIXO2:
		...
		CAIXABAIXO3:
			...
			CAIXABAIXO4:
				...
				li t2, 0x100000
				add s6, a6, t2
				ImpressaopequenaC(caixa, a6, s6, 0, 304, APAGABAIXO)
